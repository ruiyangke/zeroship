...
zs_check_binary_freshness "$ROOT" "$BIN" \
  "crates/zeroship-plugin-kv/src crates/zeroship-runtime/src crates/zeroship-worker/src crates/zeroship-gateway/src crates/zeroship-control/src sdks/kv/src" \
