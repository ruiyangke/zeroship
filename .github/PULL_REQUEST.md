...
- `docs/archive/superpowers/zeroship-builder-spec-compliance.md` — section-by-section spec walkthrough table
- `docs/archive/superpowers/zeroship-builder-status.md` — branch maturity assessment
- `docs/archive/superpowers/plans/2026-05-01-zeroship-builder-plan-02-builder-finish.md` — retroactive plan covering the ~120 commits
...
1. **Read the spec compliance table first** (`docs/archive/superpowers/zeroship-builder-spec-compliance.md`) — it gives you the section-by-section verdict in 5 minutes.
