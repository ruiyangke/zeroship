...
impl Inner {
    ...
    pub fn kind(&self) -> &Kind {
        match *self {
            ...
            // `_record` is declared as a pseudo-type, but PostgreSQL gives it
            // array_send/array_recv and typelem=record and legally emits it.
            // Kind describes the value's wire structure: without Array here,
            // Vec<T> refuses the value before T can decode each record.
