...
├── zeroship-data-query-builder/ Runtime query grammar and compilation, SchemaName, catalog metadata, sentinel codec. No drivers or V8. DDL and schema differencing belong to the migration engine.
