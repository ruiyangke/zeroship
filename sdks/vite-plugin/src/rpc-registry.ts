...
export function buildServerEntrySource(opts: {
  ...
  // Namespace-walk normaliser. ~30 lines of static glue — no helpers,
  // no dispatcher. The runtime's `__zsDispatch` consumes the resulting
  // dict-shape `default.rpc`.
...
const _zsFetch = (typeof _zsUserDefault.fetch === "function")
  ...
  : (typeof _zsUser.fetch === "function" ? _zsUser.fetch : undefined);
