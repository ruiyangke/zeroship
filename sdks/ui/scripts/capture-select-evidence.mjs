 ...
 * so the capture can show the popup at rest for the visual evidence
 * the brief asks for (the dropdown is the whole point of Select).
 */
...
const stories = [
  ...
  { id: "components-select--with-groups", open: true, trigger: '[data-testid="select-groups"]' },
  { id: "components-select--all-sizes", open: false },
  { id: "components-select--all-variants", open: false },
  { id: "components-select--multiple", open: true, trigger: '[data-testid="select-multiple"]' },
  { id: "components-select--disabled", open: false },
  { id: "components-select--with-label", open: false },
  { id: "components-select--required", open: false },
  { id: "components-select--required-invalid", open: false },
  { id: "components-select--long-list", open: true, trigger: '[data-testid="select-long-list"]' },
  { id: "components-select--align-start-center-end", open: false },
  { id: "components-select--placement", open: false },
  { id: "components-select--rtl", open: false },
];
...
try {
  ...
  for (const theme of themes) {
    for (const story of stories) {
      ...
      await page
        .locator(".zs-select-trigger, .zs-select-popup")
        .first()
      ...
      const file = join(outDir, `${theme.value}-select-${story.id}.png`);
  ...
  await writeFile(
    join(outDir, "select-evidence.json"),
