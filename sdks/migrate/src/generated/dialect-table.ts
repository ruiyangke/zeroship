...
export const DIALECT_TABLE: readonly DispositionRow[] = [
  ...
  { kind: "createPartition", variant: "base", postgres: "portable", sqlite: "unsupported", mysql: "unsupported" },
  ...
  { kind: "setColumnDefault", variant: "fn", postgres: "unsupported", sqlite: "unsupported", mysql: "unsupported" },
