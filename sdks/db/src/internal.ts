...
// The operator charter's projection. `@zeroship/bootstrap` stamps `assign` onto
// the descriptor's FieldDefs from this, and fences creator-declared field names
// against it, so both packages read ONE generated view of
// policies/confined-system-shape.inject.toml rather than each restating the
// column list. Regenerated by policies/codegen.mjs; drift is caught by
// tests/inject_policy_mirror_gate.sh.
export {
  CONFINED_SYSTEM_SHAPE_COLUMNS,
  CONFINED_SYSTEM_SHAPE_COLUMN_NAMES,
  CONFINED_SYSTEM_SHAPE_ASSIGNMENTS,
} from "./generated/confined-system-shape.generated";
export type {
  PlatformAssignment,
