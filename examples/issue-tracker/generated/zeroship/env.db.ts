...
const schema = {
  ...
  }).uniqueIndex("bug_cc_pair_uniq", ["bugId","userId"]).index("bug_cc_user_idx", ["userId"]).index("bugCc_deleted_at_idx", ["deleted_at"]).index("bugCc_updated_at_idx", ["updated_at"]).index("bugCc_created_by_idx", ["created_by"]),
  bugDependencies: defineSchema({
    bugId: t.string().required(),
    dependsOnId: t.string().required(),
  }).uniqueIndex("bug_deps_pair_uniq", ["bugId","dependsOnId"]).index("bug_deps_depends_idx", ["dependsOnId"]).index("bugDependencies_deleted_at_idx", ["deleted_at"]).index("bugDependencies_updated_at_idx", ["updated_at"]).index("bugDependencies_created_by_idx", ["created_by"]),
  bugGroups: defineSchema({
    bugId: t.string().required(),
    groupId: t.string().required(),
  }).uniqueIndex("bug_groups_pair_uniq", ["bugId","groupId"]).index("bug_groups_group_idx", ["groupId"]).index("bugGroups_deleted_at_idx", ["deleted_at"]).index("bugGroups_updated_at_idx", ["updated_at"]).index("bugGroups_created_by_idx", ["created_by"]),
  bugKeywords: defineSchema({
    bugId: t.string().required(),
    keywordId: t.string().required(),
  }).uniqueIndex("bug_keywords_pair_uniq", ["bugId","keywordId"]).index("bug_keywords_keyword_idx", ["keywordId"]).index("bugKeywords_deleted_at_idx", ["deleted_at"]).index("bugKeywords_updated_at_idx", ["updated_at"]).index("bugKeywords_created_by_idx", ["created_by"]),
  bugSeeAlso: defineSchema({
    bugId: t.string().required(),
    url: t.string().required(),
  }).uniqueIndex("bug_see_also_pair_uniq", ["bugId","url"]).index("bugSeeAlso_deleted_at_idx", ["deleted_at"]).index("bugSeeAlso_updated_at_idx", ["updated_at"]).index("bugSeeAlso_created_by_idx", ["created_by"]),
  bugs: defineSchema({
  ...
  flagTypes: defineSchema({
    name: t.string().required(),
    description: t.string(),
    targetType: t.string().required().default("bug"),
  ...
  }).index("flags_bug_idx", ["bugId"]).index("flags_attachment_idx", ["attachmentId"]).index("flags_requestee_idx", ["requesteeId"]).index("flags_setter_idx", ["setterId"]).index("flags_deleted_at_idx", ["deleted_at"]).index("flags_updated_at_idx", ["updated_at"]).index("flags_created_by_idx", ["created_by"]),
  ...
  groups: defineSchema({
    ...
    description: t.string(),
    isBugGroup: t.boolean().required().default(true),
  ...
  notifications: defineSchema({
    userId: t.string().required(),
    bugId: t.string(),
    kind: t.string().required().default("bug_changed"),
  ...
  }).uniqueIndex("votes_pair_uniq", ["bugId","userId"]).index("votes_user_idx", ["userId"]).index("votes_deleted_at_idx", ["deleted_at"]).index("votes_updated_at_idx", ["updated_at"]).index("votes_created_by_idx", ["created_by"]),
