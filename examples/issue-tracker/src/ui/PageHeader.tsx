...
const TITLE_CLASSES =
  "col-start-1 m-0 min-w-0 text-xl text-ink [font-weight:var(--it-weight-semibold)] [line-height:var(--it-leading-tight)]";
const DESCRIPTION_CLASSES =
  "col-start-1 m-0 min-w-0 text-base text-ink-secondary [line-height:var(--it-leading-snug)]";
