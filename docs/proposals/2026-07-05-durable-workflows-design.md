...
- **Status:** Superseded by the [workflow coordination design](2026-09-11-workflow-worker.md). Retained as historical design context; use the replacement for implementation decisions.
- **Date:** 2026-07-05
