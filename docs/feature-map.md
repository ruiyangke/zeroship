...
| gateway auth fail-closed default (SEC-5) | 🟢 | internal | `crates/zeroship-gateway/src/compiled.rs` | `docs/reference/rpc.md` | `crates/zeroship-gateway/src/compiled.rs` | rpc: defaults to user; anonymous needs publiclyAccessible. |
