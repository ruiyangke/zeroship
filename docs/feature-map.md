...
| env.db generated type augmentation | 🟢 | `generated/zeroship/env.db.ts` in tsconfig include | `crates/zeroship-migrate/src/frontend/gen_types.rs` | `docs/reference/db.md` | `crates/zeroship-migrate/tests/gen_types_dts_golden.rs` | Folded migration set is canonical; `@zeroship/db/env` is retired. |
