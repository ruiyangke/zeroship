...
| Descriptor assignments | 🟢 | declared generators on Row<S> fields | `crates/zeroship-data-sql/src/compile.rs`, `crates/zeroship-data-orm/src/crud/assignment_pass.rs` | `docs/reference/db.md` | `sdks/db/tests/p7-pr1-system-field-builders.test.ts` | Generators and lifecycle roles come from the migration-generated descriptor. |
