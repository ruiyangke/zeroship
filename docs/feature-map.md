...
| @zeroship/payments — buildCheckoutSession | 🟢 | `buildCheckoutSession(apiKey, opts)` | `sdks/payments/src/checkout.ts` | `docs/reference/billing-metering.md` | `sdks/payments/tests/webhook.test.ts` | 15% fee default (not server-enforced); dual metadata. |
