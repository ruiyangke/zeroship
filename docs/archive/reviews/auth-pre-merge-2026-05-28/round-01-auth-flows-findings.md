...
**File:** `crates/zeroship-auth/src/ui/reset.rs:228-260`, `crates/zeroship-auth/src/ui/login.rs:60-68`
...
**File:** `crates/zeroship-auth/src/ui/login.rs:60-68`, `crates/zeroship-auth/src/ui/magic.rs:439-568`, `crates/zeroship-auth/src/ui/magic.rs:757-857`, `crates/zeroship-auth/src/ui/oauth_google.rs:264-377`, `crates/zeroship-auth/src/ui/oauth_github.rs:255-361`
...
**File:** `crates/zeroship-auth/src/ui/link.rs:141-221`, `crates/zeroship-auth/src/identity/linker.rs:275-302`
...
**File:** `crates/zeroship-auth/src/ui/oauth_google.rs:238-340`, `crates/zeroship-auth/src/ui/oauth_github.rs:229-328`, `crates/zeroship-auth/src/ui/link.rs:224-284`
...
**File:** `crates/zeroship-auth/src/identity/magic_link.rs:105-129`, `crates/zeroship-auth/src/identity/password_reset.rs:80-118`, `crates/zeroship-auth/src/identity/verification.rs:66-96`
...
**File:** `crates/zeroship-auth/src/ui/reset.rs:250-256`, `crates/zeroship-auth/src/identity/magic_link.rs:149-197`, `crates/zeroship-auth/src/ui/magic.rs:698-857`
...
**File:** `crates/zeroship-auth/src/ui/magic.rs:371-473`, `crates/zeroship-auth/src/ui/magic.rs:574-624`
...
**File:** `crates/zeroship-auth/src/ui/magic.rs:810-831`, `crates/zeroship-auth/src/ui/magic.rs:977-1040`
...
**File:** `crates/zeroship-auth/src/ui/logout.rs:133-143`, `crates/zeroship-auth/src/ui/logout.rs:173-184`
...
**File:** `crates/zeroship-auth/src/identity/magic_link.rs:105-113`
...
**File:** `crates/zeroship-auth/src/ui/reset.rs:91-151`, `crates/zeroship-auth/src/ui/verify.rs:39-75`, `crates/zeroship-auth/src/identity/password_reset.rs:134-148`, `crates/zeroship-auth/src/identity/verification.rs:108-124`
...
**File:** `crates/zeroship-auth/src/ui/signup.rs:156-166`, `crates/zeroship-auth/src/ui/signup.rs:241-244`
...
- `crates/zeroship-auth/src/ui/login.rs::post` — password verification uses Argon2 through `spawn_blocking`, with dummy-hash padding for absent, locked, and OAuth-only users.
- `crates/zeroship-auth/src/ui/signup.rs::post`, `forgot.rs::post`, `reset.rs::post`, `link.rs::post`, `logout.rs::post`, `magic.rs::start`, and `magic.rs::complete` — state-mutating POSTs perform CSRF verification against the shared CSRF cookie.
- `crates/zeroship-auth/src/csrf.rs` — CSRF cookies are host-prefixed in production and use `SameSite=Strict`; token comparison is constant-time for equal-length inputs.
- `crates/zeroship-auth/src/sessions/login.rs` and `crates/zeroship-auth/src/ui/oauth_stash.rs` — session and OAuth stash cookies set `Path=/`, `HttpOnly`, `SameSite=Lax`, and `Secure` in production.
- `crates/zeroship-auth/src/ui/oauth_google.rs::callback` — callback verifies the signed stash, `state`, PKCE verifier, Google ID-token signature, and OIDC nonce before linking.
- `crates/zeroship-auth/src/ui/oauth_github.rs::callback` — callback verifies the signed stash, `state`, PKCE verifier, and uses GitHub's verified primary email selection before linking.
- `crates/zeroship-auth/src/identity/password_reset.rs::redeem` and `crates/zeroship-auth/src/identity/verification.rs::redeem` — token redemption itself uses atomic `UPDATE ... RETURNING` single-use semantics.
- `crates/zeroship-auth/src/identity/magic_link.rs::redeem_pending` — login token reservation uses atomic `UPDATE ... RETURNING` and prevents concurrent double reservation within the pending window.
