...
- File: `crates/zeroship-auth/src/ui/reset.rs:188`
- Related: `crates/zeroship-auth/src/main.rs:94`, `crates/zeroship-auth/src/server.rs:202`, `crates/zeroship-auth/src/server.rs:225`
...
- File: `crates/zeroship-auth/src/ui/login.rs:241`
- Related: `crates/zeroship-auth/src/ui/login.rs:327`, `crates/zeroship-auth/src/ui/reset.rs:215`, `crates/zeroship-auth/src/ui/reset.rs:229`
...
- File: `crates/zeroship-auth/src/ui/magic.rs:1047`
- Related: `crates/zeroship-auth/src/ui/magic.rs:1067`, `crates/zeroship-auth/src/ui/magic.rs:1094`, `crates/zeroship-auth/src/ui/magic.rs:1122`
...
- File: `crates/zeroship-auth/src/ui/consent.rs:168`
- Related: `crates/zeroship-auth/src/ui/consent.rs:190`, `crates/zeroship-auth/src/ui/consent.rs:75`, `crates/zeroship-auth/src/ui/consent.rs:86`
...
- File: `crates/zeroship-control/src/oauth_grants_handlers.rs:94`
- Related: `crates/zeroship-control/src/oauth_grants_handlers.rs:118`, `crates/zeroship-auth/src/ui/consent.rs:271`
...
- File: `crates/zeroship-auth/src/identity/magic_link.rs:107`
- Related: `crates/zeroship-auth/src/identity/magic_link.rs:116`, `crates/zeroship-auth/src/identity/password_reset.rs:84`, `crates/zeroship-auth/src/identity/password_reset.rs:105`, `crates/zeroship-auth/src/identity/verification.rs:69`, `crates/zeroship-auth/src/identity/verification.rs:84`
...
- File: `crates/zeroship-control/src/bootstrap_builder.rs:103`
- Related: `crates/zeroship-control/src/bootstrap_builder.rs:116`, `crates/zeroship-control/src/bootstrap_builder.rs:117`, `crates/zeroship-control/src/bootstrap_builder.rs:118`
...
- File: `crates/zeroship-auth/src/identity/magic_link.rs:201`
- Related: `crates/zeroship-auth/src/identity/magic_link.rs:156`, `crates/zeroship-auth/src/identity/magic_link.rs:218`
...
- File: `crates/zeroship-auth/src/bootstrap/mod.rs:62`
- Related: `crates/zeroship-auth/src/bootstrap/mod.rs:65`, `crates/zeroship-auth/src/hydra_client/clients.rs:11`
...
- File: `crates/zeroship-control/src/rate_limit.rs:45`
- Related: `crates/zeroship-control/src/main.rs:370`, `crates/zeroship-control/src/main.rs:371`, `crates/zeroship-control/src/http_util.rs:47`
...
- JWK rotation: `crates/zeroship-auth/src/cron/jwk_rotation.rs:114` takes a per-set advisory lock before reading `auth.cron_state` and holds it through Hydra retirement/rotation plus the `cron_state` write.
- JWK signing-key bootstrap: `crates/zeroship-auth/src/bootstrap/keys.rs:29` holds the bootstrap advisory lock before reading Hydra JWKS and through missing-key creation.
- Auth DB-backed rate limiter: `crates/zeroship-auth/src/store/ratelimit.rs:40` uses one `INSERT ... ON CONFLICT DO UPDATE ... RETURNING` statement; same-bucket attempts serialize on the row.
