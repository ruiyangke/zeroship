...
**Found by:** R5-C1 (95%)
**Files:** `crates/zeroship-gateway/src/wrapper_token.rs:309-314`, `crates/zeroship-gateway/src/router/auth.rs:216-235`, `crates/zeroship-gateway/src/dpop_exchange.rs:190`
...
**Found by:** R5-C2 (90%)
**File:** `crates/zeroship-gateway/src/router/auth.rs:240-266`
...
**Files:** `crates/zeroship-auth/src/config.rs:37-47`, `crates/zeroship-auth/src/main.rs:46-52`
...
**Files:** `crates/zeroship-auth/src/ratelimit.rs:58-77`, `crates/zeroship-auth/src/store/ratelimit.rs:30-78`
...
**Found by:** R2-H1 (90%)
**Files:** `crates/zeroship-auth/src/identity/magic_link.rs:136`, `crates/zeroship-auth/src/identity/password_reset.rs:50`, `crates/zeroship-auth/src/ui/magic.rs:358`
...
**Files:** `crates/zeroship-auth/src/identity/linker.rs:192,218,233`, `crates/zeroship-auth/src/ui/oauth_google.rs:390`
...
**Found by:** R2-H3 (90%)
**Files:** `crates/zeroship-auth/src/ui/magic.rs:498`, `crates/zeroship-auth/src/ui/magic.rs:563`
...
**Found by:** R5-H1 (90%)
**Files:** `crates/zeroship-gateway/src/oidc_rp.rs:224`, `crates/zeroship-control/src/oidc_rp.rs:183`, `crates/zeroship-core/src/oidc_verify.rs:322`
...
**File:** `crates/zeroship-core/src/oidc_verify.rs:328-334`
...
**Found by:** R5-H3 (95%)
**Files:** `crates/zeroship-core/src/logout_token.rs:54-57`, `crates/zeroship-gateway/src/backchannel_logout.rs:60-75`, `crates/zeroship-control/src/backchannel_logout.rs:66-81`
...
**Found by:** R5-H4 (90%)
**File:** `crates/zeroship-core/src/logout_token.rs:189-193`
...
**Found by:** R4-H1 (90%)
**File:** `crates/zeroship-auth/src/cron/jwk_rotation.rs:72-190`
...
**Found by:** R4-H3 (95%)
**Files:** `crates/zeroship-auth/src/hydra_client/mod.rs:{55,79,98,118}`
...
**Found by:** R5-M3 (95%)
**File:** `crates/zeroship-gateway/src/signing.rs:35-38`
