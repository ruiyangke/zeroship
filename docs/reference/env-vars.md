...
Google OAuth: `ZEROSHIP_AUTH_GOOGLE_CLIENT_ID` `AUTH_GOOGLE_CLIENT_SECRET`
`ZEROSHIP_AUTH_GOOGLE_AUTH_URL` `ZEROSHIP_AUTH_GOOGLE_TOKEN_URL` `ZEROSHIP_AUTH_GOOGLE_JWKS_URL`
`ZEROSHIP_AUTH_GOOGLE_ISSUER` `ZEROSHIP_AUTH_GOOGLE_REDIRECT_URI`

GitHub OAuth: `ZEROSHIP_AUTH_GITHUB_CLIENT_ID` `AUTH_GITHUB_CLIENT_SECRET`
`ZEROSHIP_AUTH_GITHUB_AUTHORIZE_URL` `ZEROSHIP_AUTH_GITHUB_TOKEN_URL` `ZEROSHIP_AUTH_GITHUB_USER_URL`
`ZEROSHIP_AUTH_GITHUB_EMAILS_URL` `ZEROSHIP_AUTH_GITHUB_REDIRECT_URI`

Mail: `ZEROSHIP_AUTH_MAILER` `ZEROSHIP_AUTH_MAIL_FROM_EMAIL` `ZEROSHIP_AUTH_MAIL_FROM_NAME`
`AUTH_RESEND_API_KEY` `ZEROSHIP_AUTH_SMTP_HOST` `ZEROSHIP_AUTH_SMTP_PORT` `ZEROSHIP_AUTH_SMTP_USERNAME`
`AUTH_SMTP_PASSWORD` `ZEROSHIP_AUTH_SMTP_TLS` `ZEROSHIP_AUTH_RELAY_FORWARD_MAILER`
`ZEROSHIP_AUTH_RELAY_SMTP_HOST` `ZEROSHIP_AUTH_RELAY_SMTP_PORT` `ZEROSHIP_AUTH_RELAY_SMTP_USERNAME`
`AUTH_RELAY_SMTP_PASSWORD` `ZEROSHIP_AUTH_RELAY_SMTP_TLS` `ZEROSHIP_AUTH_RELAY_INBOUND_USER`
`AUTH_RELAY_INBOUND_PASSWORD` `ZEROSHIP_AUTH_POSTMARK_WEBHOOK_USER`
