...
### [R10-API4] (ACTUALLY CLOSED at `<r21-api1-hash>`, corrected from premature close at `528c3c44`) `readyz` 503 body aligned to §10.0 envelope — sandbox-agent side (api-surface-r10 + R21-API1)
- **Source**: 2026-05-25 api-surface-r10
