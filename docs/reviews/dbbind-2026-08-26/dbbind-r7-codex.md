...
(crates/zeroship-data-v8/src/transaction/mod.rs). The present settle
path can also remove no client, declare success, release the claim, and send no
terminal SQL (crates/zeroship-data-v8/src/transaction/mod.rs).
...
(crates/zeroship-data-v8/src/transaction/mod.rs), while the driver
...
(crates/zeroship-data-v8/src/context.rs;
crates/zeroship-data-v8/src/context.rs), and a
confirmed root commit drains all of it
(crates/zeroship-data-v8/src/transaction/mod.rs). Those facts require
...
(crates/zeroship-data-v8/src/context.rs;
crates/zeroship-data-v8/src/transaction/mod.rs), while correcting the
...
(crates/zeroship-data-v8/src/transaction/mod.rs,325-343). Monotonic
...
(crates/zeroship-data-v8/src/exec.rs). The new reducer preserves those
...
(crates/zeroship-data-v8/src/backend/sqlite/session.rs). One blocking
actor loop completes run_* and sends the reply before receiving another command
(crates/zeroship-data-v8/src/backend/sqlite/session.rs). Both the
command documentation and session Drop state that a dropped caller does not
cancel the SQL
(crates/zeroship-data-v8/src/backend/sqlite/session.rs,641-657).
...
(crates/zeroship-data-v8/src/backend/sqlite/error.rs,52-140). Therefore
...
(crates/zeroship-data-v8/src/error.rs).
...
(crates/zeroship-data-v8/src/backend/sqlite/session.rs). The new
...
(crates/zeroship-data-v8/src/backend/sqlite/session.rs;
crates/zeroship-data-v8/src/backend/sqlite/error.rs).
...
| SQLITE_BUSY (5), BUSY_RECOVERY (261), BUSY_TIMEOUT (773) | ordinary operation, cancellation did not own | LockContention/lock_not_available. The present mapper already groups these (crates/zeroship-data-v8/src/backend/sqlite/error.rs,58-70). If emitted by terminal SQL, use the terminal classifier above instead. |
...
(crates/zeroship-data-v8/src/transaction/mod.rs;
crates/zeroship-data-v8/src/transaction/mod.rs), and the
...
(crates/zeroship-data-v8/src/context.rs). A passing two-isolate/
