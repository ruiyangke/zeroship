...
the deletions, not only by a classifier.

## Live defects: moved

Sixteen numbered defects (L1-L16) in the code this design touches now live in
...
magnitude wrong - the correction.

They were extracted because they are the most perishable content here: rows
retire as fixes land, five already have, and a register interleaved with the
design made both harder to read and the register harder to keep current.
...
question and is the one open decision) and **L16** (four round trips and no
...
`docs/proposals/2026-08-26-verification-record.md`.

It was extracted because it had grown into roughly a third of this document and
because it has a different lifetime: the defect register below expires as fixes
