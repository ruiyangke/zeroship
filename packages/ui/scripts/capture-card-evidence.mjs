/*
 * Capture-card-evidence: spins up an http-server over storybook-static,
 * loads each Card story under both both Crystal themess, and writes a 2x PNG
...
try {
  ...
  await writeFile(
    join(outDir, "card-evidence.json"),
