// Regenerate this package's typings from the `postgres` crate's exported vocabulary.
...
const { dialect, count, byScope } = await generate({
  vocabularyPath: resolve(here, "../../../crates/zeroship-migrate-postgres/attribute-vocabulary.json"),
