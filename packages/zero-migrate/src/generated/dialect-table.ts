...
export const DIALECT_TABLE: readonly DispositionRow[] = [
  ...
  { kind: "addConstraint", variant: "fkComposite", postgres: "portable", sqlite: "portable", mysql: "portable" },
  { kind: "addConstraint", variant: "fkNoLocalColumn", postgres: "unsupported", sqlite: "unsupported", mysql: "unsupported" },
  { kind: "addConstraint", variant: "fkNonId", postgres: "portable", sqlite: "portable", mysql: "portable" },
  ...
  { kind: "addConstraint", variant: "unique", postgres: "portable", sqlite: "unsupported", mysql: "portable" },
  ...
  { kind: "createTrigger", variant: "bodyMultipleEvents", postgres: "unsupported", sqlite: "unsupported", mysql: "unsupported" },
  ...
  { kind: "dropColumnDefault", variant: "base", postgres: "portable", sqlite: "unsupported", mysql: "portable" },
  { kind: "dropColumnNotNull", variant: "base", postgres: "portable", sqlite: "unsupported", mysql: "unsupported" },
  ...
  { kind: "insert", variant: "onConflictDoNothing", postgres: "portable", sqlite: "portable", mysql: "unsupported" },
  { kind: "insert", variant: "onConflictDoUpdate", postgres: "portable", sqlite: "portable", mysql: "portable" },
  ...
  { kind: "setColumnDefault", variant: "base", postgres: "portable", sqlite: "unsupported", mysql: "portable" },
  { kind: "setColumnDefault", variant: "containerOrJson", postgres: "portable", sqlite: "unsupported", mysql: "portable" },
  { kind: "setColumnDefault", variant: "nextval", postgres: "portable", sqlite: "unsupported", mysql: "unsupported" },
  { kind: "setColumnNotNull", variant: "base", postgres: "portable", sqlite: "unsupported", mysql: "unsupported" },
  { kind: "setColumnType", variant: "base", postgres: "portable", sqlite: "unsupported", mysql: "portable" },
