...
var SCHEMA_ONLY_KEYS = ["schema"];
var SET_TYPE_KEYS = ["to", "using", "schema"];
var PK_ADD_KEYS = ["columns"];
var PK_REPLACE_KEYS = ["expectedColumns", "columns", "dropIdentityFrom"];
var PK_DROP_KEYS = ["expectedColumns", "dropIdentityFrom"];
