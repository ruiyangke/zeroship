...
//!
//! The same dependency rule governs every one of them: a trait declared in the engine
//! would force every vendor to depend on the engine, which already depends on every
//! vendor.
//!
//! ```text
