...
/// The result of [`check_checksum_drift`](crate::check_checksum_drift): the per-version checksum mismatches
...
///
/// Assembled by the caller from [`check_checksum_drift`](crate::check_checksum_drift) and
