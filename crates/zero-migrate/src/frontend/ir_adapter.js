...
//
// This module is the runtime-entry glue evaluated inside the V8 host runtime's
...
// `zero-migrate` differ consumes (`desired_snapshot` /
...
// must match `crates/zero-migrate/src/declarative.rs::FieldDescriptor`.
