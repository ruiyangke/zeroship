...
pub const DIALECT_TABLE: &[DispositionRow] = &[
    ...
    DispositionRow { kind: "addConstraint", variant: "fkComposite", postgres: Disposition::Portable, sqlite: Disposition::Portable, mysql: Disposition::Portable },
    ...
    DispositionRow { kind: "addConstraint", variant: "fkNonId", postgres: Disposition::Portable, sqlite: Disposition::Portable, mysql: Disposition::Portable },
    ...
    DispositionRow { kind: "addConstraint", variant: "unique", postgres: Disposition::Portable, sqlite: Disposition::Unsupported, mysql: Disposition::Portable },
    ...
    DispositionRow { kind: "createTrigger", variant: "bodyMultipleEvents", postgres: Disposition::Unsupported, sqlite: Disposition::Unsupported, mysql: Disposition::Unsupported },
    ...
    DispositionRow { kind: "dropColumnDefault", variant: "base", postgres: Disposition::Portable, sqlite: Disposition::Unsupported, mysql: Disposition::Portable },
    DispositionRow { kind: "dropColumnNotNull", variant: "base", postgres: Disposition::Portable, sqlite: Disposition::Unsupported, mysql: Disposition::Unsupported },
    ...
    DispositionRow { kind: "insert", variant: "onConflictDoNothing", postgres: Disposition::Portable, sqlite: Disposition::Portable, mysql: Disposition::Unsupported },
    DispositionRow { kind: "insert", variant: "onConflictDoUpdate", postgres: Disposition::Portable, sqlite: Disposition::Portable, mysql: Disposition::Portable },
    ...
    DispositionRow { kind: "setColumnDefault", variant: "base", postgres: Disposition::Portable, sqlite: Disposition::Unsupported, mysql: Disposition::Portable },
    DispositionRow { kind: "setColumnDefault", variant: "containerOrJson", postgres: Disposition::Portable, sqlite: Disposition::Unsupported, mysql: Disposition::Portable },
    ...
    DispositionRow { kind: "setColumnNotNull", variant: "base", postgres: Disposition::Portable, sqlite: Disposition::Unsupported, mysql: Disposition::Unsupported },
    DispositionRow { kind: "setColumnType", variant: "base", postgres: Disposition::Portable, sqlite: Disposition::Unsupported, mysql: Disposition::Portable },
