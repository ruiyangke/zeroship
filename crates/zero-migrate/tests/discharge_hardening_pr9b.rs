...
fn forged_ddl(version: &zero_migrate::model::migration::MigrationId, up: &str) -> PlanStep {
...
async fn forged_contract_versionids_with_innocuous_sql_do_not_discharge() {
    ...
    let create = zero_migrate::model::migration::Migration {
    ...
    let result = engine
        ...
        .await;
    match result {
        Err(zero_migrate::DeclarativeApplyError::Plain(
