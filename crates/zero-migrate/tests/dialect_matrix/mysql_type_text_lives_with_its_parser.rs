...
//! and this file asserts a flat zero over `crates/zero-migrate/src` rather than a
...
//! 3. THE ENGINE REACHES IT FROM NOWHERE. Nothing under `crates/zero-migrate/src`
...
const FORMER_SPELLER_HOMES: [&str; 2] = [
    "crates/zero-migrate/src/apply/drift.rs",
...
fn mysql_type_text_lives_with_its_parser() {
    ...
    let former_drift = include_str!("../../src/apply/drift.rs");
