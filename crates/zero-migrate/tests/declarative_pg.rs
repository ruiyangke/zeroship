...
const DEFAULT_POSTGIS_DSN: &str =
    "host=localhost port=5435 user=postgres password=zeroship dbname=zero_migrate_test";
...
async fn all_twelve_supported_types_still_map() {
    ...
    use zero_migrate::dsl_to_pg_data_type;
    for (tok, expected) in [
        ("string", "text"),
        ("ref", "text"),
        ("actor", "text"),
