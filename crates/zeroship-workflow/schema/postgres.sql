...
CREATE TABLE "workflow"."app_state" ("app_id" text PRIMARY KEY NOT NULL, "revision" bigint NOT NULL, "policy" text, "signal_epoch" bigint NOT NULL, "last_polled_at" bigint NOT NULL DEFAULT 0, "subscription_sequence" bigint NOT NULL DEFAULT 0);
...
INSERT INTO workflow.schema_version (id, fingerprint) VALUES ('workflow', '9073496001ee8d3cb9359d6a93766ac92aa9ec45e22773e5cfd3d7bb71077ab9');
