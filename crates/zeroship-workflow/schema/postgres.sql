...
CREATE TABLE "workflow"."apps" ("app_id" text PRIMARY KEY NOT NULL, "revision" bigint NOT NULL, "policy" text, "signal_epoch" bigint NOT NULL, "last_polled_at" bigint NOT NULL DEFAULT 0, "subscription_sequence" bigint NOT NULL DEFAULT 0);
...
INSERT INTO workflow.schema_version (id, fingerprint) VALUES ('workflow', '4448da5b91a1ee418c88eeb0e52d2a1a15e630e11faa3e823f777a6998fc9bbe');
