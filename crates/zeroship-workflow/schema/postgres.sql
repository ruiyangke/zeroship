...
CREATE TABLE "workflow"."apps" ("app_id" text PRIMARY KEY NOT NULL, "revision" bigint NOT NULL, "policy" text NOT NULL, "signal_epoch" bigint NOT NULL, "last_polled_at" bigint NOT NULL DEFAULT 0, "subscription_sequence" bigint NOT NULL DEFAULT 0);
