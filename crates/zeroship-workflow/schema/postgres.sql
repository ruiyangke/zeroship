...
CREATE TABLE "workflow"."apps" ("app_id" text PRIMARY KEY NOT NULL, "revision" bigint NOT NULL, "policy" text NOT NULL, "signal_epoch" bigint NOT NULL);
...
INSERT INTO workflow.schema_version (id, fingerprint) VALUES ('workflow', '7bf3598b94c9ff9a06f5de93bc94a110b48056122339eaef141c583067a1c0fe');
