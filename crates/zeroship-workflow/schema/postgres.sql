...
CREATE TABLE "workflow"."app_state" ("app_id" text PRIMARY KEY NOT NULL, "revision" bigint NOT NULL, "policy" text, "signal_epoch" bigint NOT NULL, "platform_app_id" text, "deploy_revision" bigint NOT NULL DEFAULT 0, "last_polled_at" bigint NOT NULL DEFAULT 0, "subscription_sequence" bigint NOT NULL DEFAULT 0);

CREATE UNIQUE INDEX IF NOT EXISTS "platform_app_identity" ON "workflow"."app_state" ("platform_app_id");
...
CREATE TABLE "workflow"."topics" ("app_id" text NOT NULL, "topic" text NOT NULL, "signal_epoch" bigint NOT NULL, CONSTRAINT "topics_app" FOREIGN KEY ("app_id") REFERENCES "workflow"."app_state" ("app_id") ON DELETE RESTRICT, CONSTRAINT "topics_pkey" PRIMARY KEY (app_id, topic));
...
CREATE INDEX IF NOT EXISTS "signal_target_idx" ON "workflow"."signals" ("app_id", "run_id", "target_generation", "target_ordinal");
...
CREATE TABLE "workflow"."subscriptions" ("app_id" text NOT NULL, "run_id" text NOT NULL, "generation" bigint NOT NULL, "ordinal" bigint NOT NULL, "id" text NOT NULL, "topic" text NOT NULL, "created_at" bigint NOT NULL, "sequence" bigint NOT NULL, CONSTRAINT "subscription_step" FOREIGN KEY ("app_id", "run_id", "generation", "ordinal") REFERENCES "workflow"."steps" ("app_id", "run_id", "generation", "ordinal") ON DELETE RESTRICT, CONSTRAINT "subscriptions_pkey" PRIMARY KEY (app_id, run_id, generation, ordinal));

CREATE UNIQUE INDEX IF NOT EXISTS "subscription_identity" ON "workflow"."subscriptions" ("app_id", "id");

CREATE UNIQUE INDEX IF NOT EXISTS "subscription_sequence" ON "workflow"."subscriptions" ("app_id", "sequence");

CREATE INDEX IF NOT EXISTS "subscriptions_topic_idx" ON "workflow"."subscriptions" ("app_id", "topic", "id");

CREATE TABLE "workflow"."requests" ("app_id" text NOT NULL, "id" text NOT NULL, "operation" text NOT NULL, "digest" text NOT NULL, "result" text NOT NULL, "expires_at" bigint NOT NULL, CONSTRAINT "requests_app" FOREIGN KEY ("app_id") REFERENCES "workflow"."app_state" ("app_id") ON DELETE RESTRICT, CONSTRAINT "requests_pkey" PRIMARY KEY (app_id, id));
...
CREATE TABLE "workflow"."outbox" ("app_id" text NOT NULL, "id" text NOT NULL, "kind" text NOT NULL, "payload" text NOT NULL, "created_at" bigint NOT NULL, "delivered_at" bigint, CONSTRAINT "outbox_app" FOREIGN KEY ("app_id") REFERENCES "workflow"."app_state" ("app_id") ON DELETE RESTRICT, CONSTRAINT "outbox_pkey" PRIMARY KEY (app_id, id));

CREATE INDEX IF NOT EXISTS "outbox_delivery_idx" ON "workflow"."outbox" ("delivered_at", "created_at");
INSERT INTO workflow.schema_version (id, fingerprint) VALUES ('workflow', 'a367f895ef915da8f3ff196183d19557286c74a3304048b470dcedabfd6bdf97');
