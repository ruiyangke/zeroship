...
//      Invoked via the RPC wire (`POST /_zs/v1/<name>` with a superjson
...
// the URL matches /_zs/v1/<id>; we get (id, input, ctx) and return the
...
//
// Runs for every request that isn't /_zs/v1/<id> (handled by default.rpc)
...
export default {
    ...
    // zeroship extension: fast HTTP dispatch for non-/_zs/v1/ traffic.
