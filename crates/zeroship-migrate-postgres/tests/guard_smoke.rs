...
/// `zeroship-migrate-core`'s `model::validate`). The cross-schema arm is the
...
/// (crates/zeroship-migrate-core/src/model/validate.rs) refuses the same shapes first, with the
