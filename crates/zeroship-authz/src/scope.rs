...
impl Scope {
    ...
    pub const fn action(self) -> Action {
        match self {
            ...
            Self::DatabaseRead => Action::DatabaseRead,
            Self::DatabaseWrite => Action::DatabaseWrite,
            Self::DatabaseMigrate => Action::DatabaseMigrate,
            ...
            Self::OrganizationMembersLeave => Action::OrganizationMembersLeave,
    ...
    pub const fn human_label(self) -> &'static str {
        match self {
            ...
            Self::DatabaseRead => "View your databases and the apps bound to them",
            Self::DatabaseWrite => "Create and delete databases, and bind apps to them",
            Self::DatabaseMigrate => "Change the schema of your databases",
            ...
            Self::OrganizationMembersLeave => "Give up your own seat in an organization",
