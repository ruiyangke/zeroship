...
/// errors: `crates/zeroship-data-orm/src/tests/sqlite/mod.rs` obtains one by INFERENCE from
...
mod tests {
    ...
    //! is exercised end to end in `crates/zeroship-data-orm/src/tests/sqlite/mod.rs`, which is the
