...
/// errors: `crates/zeroship-data-orm/src/tests/sqlite_integration.rs` obtains one by INFERENCE from
...
mod tests {
    ...
    //! is exercised end to end in `crates/zeroship-data-orm/src/tests/sqlite_integration.rs`, which is the
