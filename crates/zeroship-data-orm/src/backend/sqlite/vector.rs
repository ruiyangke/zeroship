...
use zeroship_data_sql::compile::quote_ident;
...
pub(crate) fn build_vector_search_sql(
    ...
    let select_expr = zeroship_data_sql::compile::build_masked_aware_select_expr_for_table_alias(
        schema_hint,
        "t",
    )
...
mod tests {
    ...
    fn build_vector_search_sql_reads_masked_sibling_when_schema_cached() {
        ...
        assert!(
            !sql.contains(&zeroship_data_sql::compile::raw_column_name("ssn")),
