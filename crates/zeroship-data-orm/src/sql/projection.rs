...
use crate::sql::ident::{Ident, IdentRole};
use crate::sql::path::FieldPath;
use crate::sql::predicate::AggregateRef;
use core::fmt;
...
/// The scalar a search ranks by. Its operands live on [`crate::sql::SearchCriterion`]
...
impl SearchScalarKind {
    ...
    /// [`crate::sql::IdentRole::Alias`]'s fences - and
...
pub enum ProjectionSource {
    ...
    /// two rules depend on being able to SEE the divergence: [`crate::sql::render`]
    ...
    /// [`crate::sql::Search`]; see [`SearchScalarKind`].
...
/// crate - [`crate::sql::IdentRole::Column`] refuses the platform's storage prefixes
/// and the constructor that derived them was `pub(crate)`. Adding
/// [`crate::sql::IdentRole::StoredColumn`] the same day removed that barrier, and
...
impl ProjectedField {
    ...
    /// mapping and must parse `physical` as [`crate::sql::IdentRole::StoredColumn`].
    ///
    /// # Errors
    ///
...
impl Projection {
    ...
    /// ([`crate::sql::SearchBuilder::build`]), which is what makes
...
pub enum ProjectionError {
    Alias {
        source: crate::sql::ident::IdentError,
    },
...
mod tests {
    ...
    fn a_stray_ranking_scalar_is_refused_by_both_projections() {
        ...
        let counted = ProjectedField::aggregate(
            crate::sql::AggregateRef::count_rows(),
    ...
    /// mutation proof; the render-level half lives in `crate::sql::render`.
    #[test]
