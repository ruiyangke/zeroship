//! PostgreSQL rendering for typed plans. Unsupported nodes return `RenderError`.
...
use crate::sql::plan::{DbPlan, Direction, NullOrder, OrderKey, RowLimit, Select};
...
/// [`crate::sql::write`] for why a null is a node rather than a parameter.
///
/// # Errors
///
...
/// that (`crates/zeroship-data-orm/src/sql/compile.rs`) while the shipped vector
...
/// functions. None of them appears in [`crate::sql::search`], which is the property
