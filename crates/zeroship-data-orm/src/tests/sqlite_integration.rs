...
fn fresh_backend(host: &Host) -> (SqliteBackend, tempfile::TempDir) {
...
fn vector_l2_distance_matches_cosine_for_unit_vectors_sqlite() {
    Host::test(|host| {
        ...
        host.run(async {
            ...
            create_vec0_shadow_relation(&backend, "vector_math", "docs", "emb_cos", 4, "cosine")
                .await;
