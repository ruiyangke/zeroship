...
pub use zeroship_migrate_backend::backfill;
// The fail-closed IR envelope load gate - POLICY-bound half (`load_ir_document`);
// the policy-free half is re-exported from `zeroship_migrate_ir::load`.
pub mod load;
...
// `zeroship_migrate_ir::validate`, so `crate::model::validate::{AuthoringError,
...
pub use zeroship_migrate_ir::attribute;
pub use zeroship_migrate_ir::capability;
pub use zeroship_migrate_ir::expr;
pub use zeroship_migrate_ir::ir;
pub use zeroship_migrate_ir::migration;
pub use zeroship_migrate_ir::policy;
pub use zeroship_migrate_ir::precondition;
pub use zeroship_migrate_ir::probe;
