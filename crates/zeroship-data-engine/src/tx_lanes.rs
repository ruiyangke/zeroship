...
impl TxConnection {
    ...
    pub async fn cleanup(&self) -> CleanupAck {
        match self {
...
impl TxClientSlotGuard {
    ...
    pub fn client(&self) -> &TxConnection {
        self.client
            .as_ref()
...
impl TxLanes {
    ...
    pub fn take_tx_client_for(&mut self, app_id: &str) -> Option<TxConnection> {
    ...
    /// the pool.
    pub fn put_tx_client_for(&mut self, app_id: &str, client: TxConnection) {
    ...
    pub fn withdraw_tx_session(&mut self, app_id: &str) -> Option<TxConnection> {
