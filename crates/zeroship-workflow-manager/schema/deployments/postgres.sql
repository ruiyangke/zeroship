...
CREATE TABLE "zeroship"."app_deploys" ("id" text PRIMARY KEY NOT NULL, "app_id" text NOT NULL, "deploy_hash" text NOT NULL, "manifest_json" text NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "activated_at" timestamptz, "retention_state" text NOT NULL DEFAULT 'available', "retention_lock" bigint NOT NULL DEFAULT 0);
