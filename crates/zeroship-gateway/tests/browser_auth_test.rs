...
//! and REQUIRES a test database: with none configured it refuses and names
//! `tests/provision_test_backends.sh` instead of skipping into a green. The
//! same-origin guard + cookie-clear parts run unconditionally.
