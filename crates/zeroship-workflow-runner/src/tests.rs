...
use zeroship_workflow::{
    ...
    service::{
        schema, store::OrmStore, AppPolicy, CompletionReceipt, ControlIntent, Heartbeat,
        RequestId, TaskAssignment, TaskToken, WorkerIdentity,
    },
...
struct ObservedTasks {
    inner: WorkerTasks,
    app: zeroship_workflow::service::AppWorkflows,
    probe: Rc<Probe>,
