...
function lookup(host, cb) {
  queueMicrotask(() => cb(null, host === "localhost" ? "127.0.0.1" : String(host), 4));
}
var dns_default;
var init_dns = __esm({
  "shims/dns.js"() {
...
function enoent(path2) {
  const err = new Error("ENOENT: no such file or directory, stat " + path2);
  err.code = "ENOENT";
  return err;
}
function stat(path2, cb) {
  queueMicrotask(() => cb(enoent(path2)));
}
...
var init_fs = __esm({
  "shims/fs.js"() {
    fs_default = { stat, createReadStream };
  }
});
...
var require_pg_connection_string = __commonJS({
  "node_modules/pg-connection-string/index.js"(exports, module) {
    ...
    function parse(str, options = {}) {
      ...
      const fs = config.sslcert || config.sslkey || config.sslrootcert ? (init_fs(), __toCommonJS(fs_exports)) : null;
      if (config.sslcert) {
...
import * as node_tls_star from "node:tls";
  ...
  "node_modules/pg/lib/stream.js"(exports, module) {
    ...
    function getNodejsStreamFuncs() {
      function getStream2(ssl) {
        const net2 = (init_net(), __toCommonJS(net_exports));
        return new net2.Socket();
      }
      function getSecureStream2(options) {
        const tls2 = (init_tls(), __toCommonJS(tls_exports));
...
var require_connection = __commonJS({
  "node_modules/pg/lib/connection.js"(exports, module) {
    "use strict";
    var EventEmitter2 = (init_events(), __toCommonJS(events_exports)).EventEmitter;
...
import * as node_path_star from "node:path";
import path from "node:path";
var path_default;
var init_path = __esm({
  "shims/path.js"() {
    __reExport(path_exports, node_path_star);
    path_default = path;
  }
});
...
var Stream, Transform, stream_default;
var init_stream = __esm({
  "shims/stream.js"() {
    ...
    Transform = class extends Stream {
      constructor(options = {}) {
        super();
    ...
    stream_default = { Stream, Transform };
  }
});
...
var require_split2 = __commonJS({
  "node_modules/split2/index.js"(exports, module) {
    "use strict";
    var { Transform: Transform2 } = (init_stream(), __toCommonJS(stream_exports));
...
var require_pg_native = __commonJS({
  "shims/pg-native.js"() {
    var err = new Error("Cannot find module 'pg-native'");
