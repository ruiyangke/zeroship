...
use zeroship_migrate_js::{build_one_migration, BuildError, RecordVia, ResourceBudget};
...
fn record_one_file_is_idempotent_verbatim() {
    ...
    assert_eq!(first.migrations[0].record_path, zeroship_migrate_js::RecordPath::Local);
    ...
    assert_eq!(
        ...
        zeroship_migrate_js::RecordPath::CommittedVerbatim
    );
