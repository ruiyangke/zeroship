...
async fn diff_reports_missing_and_unexpected_columns_within_a_shared_table() {
    ...
    tables.insert(
        ...
        TableSnapshot {
            columns: vec![
                ColumnSnapshot { name: "id".into(), data_type: "integer".into(), nullable: true, default: None },
                ColumnSnapshot { name: "declared_col".into(), data_type: "text".into(), nullable: true, default: None },
            ],
            indexes: Vec::new(),
            constraints: Vec::new(),
        },
