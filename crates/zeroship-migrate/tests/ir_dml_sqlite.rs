...
async fn recorded_fnsynth_symbol_insert_applies_db_evaluated_values_on_sqlite() {
    ...
    let symbol_ir = record_migration_to_ir_unsandboxed(&zeroship_migrate_runtime::ZeroshipRuntimeHost, symbol_src, APP, "sqlite_fnsynth_symbol")
        .expect("record symbol-form fnSynth insert");
    let explicit_ir = record_migration_to_ir_unsandboxed(&zeroship_migrate_runtime::ZeroshipRuntimeHost, explicit_src, APP, "sqlite_fnsynth_explicit")
