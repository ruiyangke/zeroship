...
pub const DIALECT_TABLE: &[DispositionRow] = &[
    ...
    DispositionRow { kind: "createPartition", variant: "base", postgres: Disposition::Portable, sqlite: Disposition::TransparentDegradable, mysql: Disposition::TransparentDegradable },
    ...
    DispositionRow { kind: "createTable", variant: "partitionedCollapse", postgres: Disposition::Portable, sqlite: Disposition::TransparentDegradable, mysql: Disposition::TransparentDegradable },
