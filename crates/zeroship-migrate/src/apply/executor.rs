...
use crate::apply::backend::{MigrationBackend, PgSessionSnapshot, PostgresBackend};
...
fn non_transactional_down_reason(down: &str) -> Option<String> {
    let classes = crate::analysis::classify::classify(down).ok()?;
    ...
    for m in ordered {
        ...
        match &m.down {
            ...
            Some(down) => {
                ...
                // with the SAME classifier apply uses (`crate::analysis::classify`, whose
