...
export default {
  ...
  schema() {
    ...
    grant({ privileges: ["select", "insert", "update"], on: { kind: "table", schema: "zeroship", names: ["apps", "metric_weights", "pricing_config", "plans", "app_spend_limit", "app_spend_state", "invoices", "refunds", "billing_disputes", "billing_reconciliation_findings", "provider_dead_letter", "app_oauth_clients"] }, to: ["zeroship_control"] });
