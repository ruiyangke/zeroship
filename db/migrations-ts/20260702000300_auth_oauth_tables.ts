  ...
  schema() {
    table("app_session_anchors", { schema: "zeroship" }).create({
      columns: {
        ...
        granted_scopes: t.textArray().required().default([]),
    ...
    table("authz_decisions", { schema: "zeroship" }).create({
      columns: {
        ...
        matched_policies: t.textArray().required().default([]),
        request_ip: t.inet(),
        request_id: t.text(),
      },
      primaryKey: ["id"],
    ...
    table("oauth_authorization_codes", { schema: "zeroship" }).create({
      columns: {
        ...
        requested_scopes: t.textArray().required(),
        granted_scopes: t.textArray().required(),
        nonce: t.text(),
        user_id: t.text().required(),
        created_at: t.timestamp().required().default(now()),
        expires_at: t.timestamp().required(),
    ...
    table("oauth_clients", { schema: "zeroship" }).create({
      columns: {
        ...
        client_uri: t.text(),
        logo_uri: t.text(),
        redirect_uris: t.textArray().required(),
        scopes: t.textArray().required(),
    ...
    table("oauth_refresh_tokens", { schema: "zeroship" }).create({
      columns: {
        ...
        sub: t.text().required(),
        granted_scopes: t.textArray().required(),
        family_granted_scopes: t.textArray().required(),
        issued_at: t.timestamp().required().default(now()),
        expires_at: t.timestamp().required(),
