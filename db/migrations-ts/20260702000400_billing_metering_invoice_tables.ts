...
export function up() {
  ...
  table("app_spend_state", { schema: "zeroship" }).check("app_spend_state_eval_limit_cents_check").add({ expr: (c) => c("eval_limit_cents").ge(0) });
  table("app_spend_state", { schema: "zeroship" }).check("app_spend_state_spend_cents_check").add({ expr: (c) => c("spend_cents").ge(0) });
  ...
  pgTable("billing_disputes", { schema: "zeroship" }).check("billing_disputes_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  table("billing_line_provider_refs", { schema: "zeroship" }).check("billing_line_provider_refs_segment_no_check").add({ expr: (c) => c("segment_no").ge(0) });
  ...
  pgTable("connect_checkout_failures", { schema: "zeroship" }).check("connect_checkout_failures_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  pgTable("credit_ledger", { schema: "zeroship" }).check("credit_ledger_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  table("invoice_lines", { schema: "zeroship" }).check("invoice_lines_amount_cents_check").add({ expr: (c) => c("amount_cents").ge(0) });
  table("invoice_lines", { schema: "zeroship" }).check("invoice_lines_base_fee_cents_check").add({ expr: (c) => c("base_fee_cents").ge(0) });
  table("invoice_lines", { schema: "zeroship" }).check("invoice_lines_fx_pico_cents_per_unit_check").add({ expr: (c) => c("fx_pico_cents_per_unit").ge(1000) });
  table("invoice_lines", { schema: "zeroship" }).check("invoice_lines_included_units_check").add({ expr: (c) => c("included_units").ge(0) });
  table("invoice_lines", { schema: "zeroship" }).check("invoice_lines_segment_no_check").add({ expr: (c) => c("segment_no").ge(0) });
  ...
  pgTable("invoice_payments", { schema: "zeroship" }).check("invoice_payments_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  pgTable("invoices", { schema: "zeroship" }).check("invoices_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  table("metering_exports", { schema: "zeroship" }).check("metering_exports_consecutive_failures_check").add({ expr: (c) => c("consecutive_failures").ge(0) });
  table("metering_exports", { schema: "zeroship" }).check("metering_exports_exported_units_check").add({ expr: (c) => c("exported_units").ge(0) });
  ...
  table("metric_weights", { schema: "zeroship" }).check("metric_weights_per_units_check").add({ expr: (c) => c("per_units").gt(0) });
  table("metric_weights", { schema: "zeroship" }).check("metric_weights_units_per_op_check").add({ expr: (c) => c("units_per_op").ge(0) });
  ...
  pgTable("payout_failures", { schema: "zeroship" }).check("payout_failures_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  pgTable("pending_disputes", { schema: "zeroship" }).check("pending_disputes_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  table("pricing_config", { schema: "zeroship" }).check("pricing_config_fx_pico_cents_per_unit_check").add({ expr: (c) => c("fx_pico_cents_per_unit").ge(1000) });
  table("pricing_config", { schema: "zeroship" }).check("pricing_config_id_check").add({ expr: (c) => c("id").eq("global") });
  ...
  pgTable("refunds", { schema: "zeroship" }).check("refunds_currency_check").add({ expr: (c) => c("currency").regex("^[a-z]{3}$") });
  ...
  table("usage_aggregates", { schema: "zeroship" }).check("usage_aggregates_total_check").add({ expr: (c) => c("total").ge(0) });
