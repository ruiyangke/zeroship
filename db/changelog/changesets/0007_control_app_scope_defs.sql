...
-- Hydra client's `scope` allowlist (sync_app_scopes, §5.1). The single
-- atomicity invariant is what keeps the consent classifier sound: Hydra can
-- never accept a scope at /authorize that this registry hasn't learned.
--
