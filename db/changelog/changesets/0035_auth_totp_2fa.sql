...
--changeset zeroship:auth-totp-credentials splitStatements:true
...
--rollback DROP TABLE zeroship.totp_backup_codes;
--rollback DROP TABLE zeroship.totp_credentials;
